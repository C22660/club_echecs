...
class Menu:
    ...
    # la numérotation automatique est définie ici implémenter de 1 à chaque
    # passage
    ...
    # en obligeant la vue à passer par def items, ça évite qu'il at accès à
    #  self._entries et qu'il puisse le modifier, en générant un itérateurs
    #  grace à .items()
    def items(self):
        # renvoi un itérateur à travers les clés et les entrées dans le menu
        return self._entries.items()

    # __contains__ appelé dans la menu def get_user_choice(self): permet de
    # gérer le in pour la vérif
